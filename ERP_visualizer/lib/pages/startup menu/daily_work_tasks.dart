...
class DailyWorkTasks extends StatefulWidget {
  DailyWorkTasks({super.key, required this.accessToken, required this.logOutFunction, required this.refreshTokenFunction});
  final String? accessToken;
  final logOutFunction;
  final refreshTokenFunction;

  @override
  State<DailyWorkTasks> createState() => _DailyWorkTasksState();

}

class _DailyWorkTasksState extends State<DailyWorkTasks> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: AppText.headline1(text: "Work Assignments for Today"),
                  ),
                  Padding(
                                ...
                                Row(
                                  ...
                                  children: [
                                    CommonButton.primaryButton(
                                        text: 'Start',
                                        onPressed: () {
                                          print('Button pressed'); // Debugging print statement
                                          Navigator.pushNamed(context, '/work_task_steps');
                                        },
